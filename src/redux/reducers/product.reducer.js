...
const productReducer = createReducer(initialState, {
  ...
  [REQUEST(PRODUCT_ACTION.GET_TOP_SALE_LIST)]: (state, action) => {
    return {
      ...state,
      topSaleList: {
        ...state.topSaleList,
  ...
  [SUCCESS(PRODUCT_ACTION.GET_TOP_SALE_LIST)]: (state, action) => {
    const { data } = action.payload;
  ...
  [FAIL(PRODUCT_ACTION.GET_TOP_SALE_LIST)]: (state, action) => {
    const { error } = action.payload;
    return {
      ...state,
      topSaleList: {
